...
public class Moveset_SnowCherry : MonoBehaviour
{
    ...
    [Header("Air attack 3")]
    public int air3ID;
    public float air3StartUp;
    public float air3Active;
    public float air3Recovery;
    [Space(5)]
    public float air3Forward;
    public float air3Up;
    public float air3Duration1;
    [Space(5)]
    public float air3Forward2;
    public float air3Up2;
    public float air3Duration2;
    [Space(5)]
    public float air3Forward3;
    public float air3Up3;
    public float air3Duration3;
    [Space(10)]
    [Header("Air attack 4")]
    public int air4ID;
    public float air4StartUp;
    public float air4Active;
    public float air4Recovery;
    [Space(5)]
    public float air4Forward;
    public float air4Up;
    public float air4Duration1;
    [Space(5)]
    public float air4Forward2;
    public float air4Up2;
    public float air4Duration2;
    [Space(5)]
    public float air4Forward3;
    public float air4Up3;
    public float air4Duration3;
    [Space(10)]
    /*
    [Header("Up attack")]
    public int upID;
