...
public class Weapon_Bamboo : MonoBehaviour {
    public Movelist movelist;
    [HeaderAttribute("Moveset attributes")]
    public Moveset_Bamboo activeMoveset;
    ...
    void Awake()
    {
        activeMoveset = GetComponent<Moveset_Bamboo>();
    ...
    void FixedUpdate()
    {
        ...
        if (attackScript.attackStart + comboDelay < Time.time) attackScript.combo = 0;
    }
